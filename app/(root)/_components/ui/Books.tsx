							...
							{apiBooks.map(book => (
								...
								>
									...
									<div className="flex w-full items-center justify-end">
										<Link
											href={`/book/new${book.volumeInfo.industryIdentifiers ? `?isbn=${book.volumeInfo.industryIdentifiers[0].identifier}` : ""}`}
											className="flex w-fit items-center justify-center gap-3 rounded-2xl bg-main px-5 py-1 text-black duration-200 hover:brightness-90"
										>
											Postar esse livro
										</Link>
									</div>
